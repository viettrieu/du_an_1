    ...
    <div class="col medium-6 small-12 large-6">
        <div class="bpfw-images">
            <figure class="woocommerce-product-gallery__wrapper bpfw-flip-wrapper">
                <img src="<?= SITE_URL ?><?= $product["thumbnail"] ?>" class="wp-post-image" alt="">
                <div class="bpfw-flip bpfw-flip-front"><img src="<?= SITE_URL ?><?= $product["thumbnail"] ?>"
                        class="wp-post-image" alt="">
                </div>
                <div class="bpfw-flip bpfw-flip-back">
                    <img src="<?= SITE_URL ?><?= $product["thumbnail"] ?>" alt="Back Cover">
                </div>
...
<section id="product-author-wrap">
    <div class="row">
        ...
        <div class="col medium-8 small-12 large-8">
            <div class="col-inner">
                <div class="author-quote">" My books are marked down because most of them are marked with a on the edge
                    by
                    publishers. "</div>
            ...
            <div class="tab-pane reviews">
                <div class="row">
                                ...
                                <li>
                                    <div class="comment-main-level">
                                        <div class="comment-avatar">
                                            <img src="<?= SITE_URL ?><?= $review['avatar'] != NULL ?  $review['avatar'] : '/public/img/avatar-default.png' ?>"
                    ...
                    <div class="col medium-12 small-12 large-6 col-nop medium-col-first">
                        ...
                        <form action="" method="POST" id="reviews-form" data-id="<?= $product['id']; ?>">
                            ...
                            <div class="form-control reviews-form-comment">
                                ...
                                <textarea id="reviews" name="content" cols="45" rows="8" maxlength="1000"
                                    required></textarea>
                            </div>
