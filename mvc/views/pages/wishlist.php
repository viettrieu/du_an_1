            ...
            <tbody id="show-cart">
                ...
                <tr class="cart-item" data-id="1">
                    ...
                    <td class="product-thumbnail">
                        <a href="http://localhost/ASM_MVC//store/product/<?= $item[$key]['id']?>">
                            <!-- <img width="90" height="90"
                                src="http://localhost/ASM_MVC//public/img/product-1-600x600.jpg"> -->
                        </a>
                    </td>
                    <td class="product-name">
                        <a href="http://localhost/ASM_MVC//store/product/<?= $item[$key]['id']?>"><?php echo $item[$key]['title']?></a>
                    </td>
                    <td class="product-price" data-title="Giá" data-price="50000">
                        <span class="price">
                            <span> <?= number_format($item[$key]['price']) ?></span>
                            <sup>đ</sup>
                        </span>
                    </td>
