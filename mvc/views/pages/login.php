  ...
  <div class="col medium-8 small-12 large-5">
    ...
    <form action="" method="post" id="login-form" class="needs-validation" novalidate>
      <div class="form-group">
        <input class="form-control" id="username" name="username" type="text" value="<?= htmlspecialchars($_POST['username'] ?? ''); ?>" size="30" required placeholder="Email / Số điện thoại / Tên đăng nhập" />
      </div>
      <div class="form-group">
        <input class="form-control" id="password" name="password" type="password" value="" placeholder="Mật khẩu" required autocomplete="off" />
      </div>
      ...
      <div class="text-center" style="margin-top: 1rem">
        <button type="submit" form="login-form" name="login_user" class="button primary">
          ĐĂNG NHẬP
        </button>
      </div>
