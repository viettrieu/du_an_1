  ...
  <div class="large-9 col">
    ...
    <form action="" method="post" class="needs-validation" novalidate>
      <div class="form-group">
        <input class="form-control" id="password" name="password" type="password" value="" required placeholder="Mật khẩu cũ *" autocomplete="off" />
      </div>
      <div class="form-group">
        <input class="form-control" id="password" name="passwordnew" type="password" value="" required placeholder="Mật khẩu mới *" autocomplete="off" />
      </div>
      <div class="form-group">
        <input class="form-control" id="re_password" name="re_passwordnew" type="password" value="" required placeholder="Nhập lại mật khẩu mới *" autocomplete="off" />
      </div>
