    ...
    <article>
      ...
      <div class="entry-share">
        <ul class="social-media">
          ...
          <li>
            <a class="linkedin" href="https://www.linkedin.com/shareArticle?mini=true&url={{url}}&title={{title}}&source={{source}}" target="blank">
              <i class="fab fa-linkedin-in"></i>
            </a>
          </li>
          <li>
            <a class="pinterest" href="https://pinterest.com/pin/create/bookmarklet/?media={{media}}&url={{url}}&is_video=false&description={{title}}" target="blank">
      ...
      <div id="comments">
          ...
          <div id="comment_form_wrapper">
            ...
            <form method="POST" id="comment-form" data-id="<?= $post['id']; ?>">
              <div class="form-group comment-form-comment">
                <textarea id="comment" name="content" cols="45" rows="8" maxlength="1000" required placeholder="Nội dung  *"></textarea>
              </div>
        ...
        ?>
          <p>Vui lòng <a href="<?= SITE_URL ?>/login&refurl=<?= base64_encode($actual_link) ?>" style=" color: #cc3528; "><strong>đăng nhập</strong></a> để bình
            luận</p>
        <?php endif ?>
      </div>
