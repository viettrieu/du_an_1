                ...
                <div class="media">
                  <span class="avatar avatar-sm">
                    <img class="avatar-img rounded-circle" alt=""
                      src="<?= SITE_URL ?>/public/admin/img/profiles/avatar-02.jpg" />
                  </span>
            ...
            <li class="notification-message">
              <a href="activities.html">
                <div class="media">
                  <span class="avatar avatar-sm">
                    <img class="avatar-img rounded-circle" alt=""
                      src="<?= SITE_URL ?>/public/admin/img/profiles/avatar-03.jpg" />
                  </span>
                  <div class="media-body">
                    <p class="noti-details">
            ...
            <li class="notification-message">
              <a href="activities.html">
                <div class="media">
                  <span class="avatar avatar-sm">
                    <img class="avatar-img rounded-circle" alt=""
                      src="<?= SITE_URL ?>/public/admin/img/profiles/avatar-04.jpg" />
                  </span>
                  <div class="media-body">
                    <p class="noti-details">
