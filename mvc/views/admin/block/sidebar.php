      ...
      <div id="sidebar-menu" class="sidebar-menu">
        <ul>
          ...
          <li class="<?php if ($data["Page"] == "product") echo "active"; ?>">
            <a href="<?= ADMIN_URL; ?>/product"><i class="fas fa-boxes"></i><span>Danh sách sản phẩm</span></a>
          </li>
          <li class="<?php if ($data["Page"] == "create-product") echo "active"; ?>">
            <a href="<?= ADMIN_URL; ?>/product/create"><i class="fas fa-parachute-box"></i><span>Tạo sản phẩm
                mới</span></a>
          </li>
          ...
          <li class="<?php if ($data["Page"] == "user") echo "active"; ?>">
            <a href="<?= ADMIN_URL; ?>/user"><i class="fas fa-users"></i><span>Danh sách Thành viên</span></a>
          </li>
