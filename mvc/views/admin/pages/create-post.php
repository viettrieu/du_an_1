<div class="page-wrapper">
  <div class="content container-fluid">
    ...
    <form method="POST" id="create_post" enctype="multipart/form-data" class="needs-validation" novalidate>
      <div class="row">
        <div class="col-md-9">
          <div class="card">
            <div class="card-body">
              ...
              <div class="form-group ">
                ...
                <div class=" invalid-feedback">Vui lòng nhập tên bài viết.
                </div>
              </div>
              <div class="form-group">
        ...
        <div class="col-md-3">
          ...
          <button type="submit" name="create_post" class="btn btn-block btn-primary btn-lg">Đăng bài viết</button>
        </div>
      </div>
    </form>
  </div>
