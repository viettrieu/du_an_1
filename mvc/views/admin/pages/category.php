...
<div class="page-wrapper">
  <div class="content container-fluid">
    ...
    <div class="row">
      <div class="col-md-5">
        <form method="POST" id="create_category" class="needs-validation" novalidate>
          <div class="card">
            <div class="card-body">
                  ...
                  if (isset($ListCategory)) {
                    foreach ($ListCategory as $category) { ?>
                      <tr>
                        ...
                        <td><?php echo $category['luot']; ?></td>
                        <td class="text-right">
                          <a href="<?= ADMIN_URL ?>/category/edit/<?php echo $category['id']; ?>" class="btn btn-sm btn-white text-success mr-2"><i class="far fa-edit mr-1"></i>Sửa</a>
