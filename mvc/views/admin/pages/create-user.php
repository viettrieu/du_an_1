<div class="page-wrapper">
  <div class="content container-fluid">
    ...
    <form method="POST" id="create_user" enctype="multipart/form-data" class="needs-validation" novalidate>
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="form-group ">
                ...
                <div class="pass-group">
                  <input type="password" class="form-control pass-input" name="re_password" id="re_password" required>
