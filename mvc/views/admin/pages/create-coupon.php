<div class="page-wrapper">
  <div class="content container-fluid">
    ...
    <form method="POST" id="create_coupon" class="needs-validation" novalidate>
      <div class="row">
        <div class="col-md-9">
          <div class="card">
            <div class="card-body">
              ...
              <div class="form-group ">
                <label>Coupon:</label>
                <input type="text" class="form-control" id="code" required name="code" value="<?= htmlspecialchars($_POST['code']  ?? ''); ?>">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="number" class="form-control" id="discount" required name="discount" min="1" max="100" aria-describedby="basic-addon2" value="<?= htmlspecialchars($_POST['discount']  ?? ''); ?>">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="usageLimit" name="usageLimit" min="1" value="<?= htmlspecialchars($_POST['usageLimit']  ?? ''); ?>">
              </div>
              <div class="form-group">
                <label>Đơn hàng tối thiểu:</label>
                <div class="input-group">
                  <input type="number" class="form-control" id="minOrder" name="minOrder" min="1" aria-describedby="basic-addon3" value="<?= htmlspecialchars($_POST['minOrder']  ?? ''); ?>">
                  <div class="input-group-append">
          ...
          <div class="card">
            <div class="card-body">
              <div class="form-group">
                ...
                <div class="cal-icon">
                  <input type="text" class="form-control datetimepicker-coupon" id="startDate" name="startDate" value="<?= htmlspecialchars($_POST['startDate']  ?? ''); ?>" autocomplete="off">
                </div>
              </div>
              <div class="form-group">
                <label>Ngày kết thúc:</label>
                <div class="cal-icon">
                  <input type="text" class="form-control datetimepicker-coupon" id="expiryDate" name="expiryDate" value="<?= htmlspecialchars($_POST['expiryDate']  ?? ''); ?>" autocomplete="off">
                </div>
              </div>
