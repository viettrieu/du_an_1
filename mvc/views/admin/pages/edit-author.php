                ...
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Youtube:</label>
                                <input type="text" class="form-control" id="youtubelink" value="<?=$author['youtubelink']?>" name="youtubelink">
                            </div>
                            <div class="form-group">
                                <label>Twitter:</label>
                                <input type="text" class="form-control" id="twitterlink" value="<?=$author['twitterlink']?>" name="twitterlink">
                            </div>
                        </div>
                    </div>
