...
<div class="row page-wrapper">
  <div class="large-9 col-nop">
    <div class="row">
      ...
      $base_url = './index.php?action=search&s=' . $s;
      $totalProduct =  totalProduct('search', $s);
      $productList = productList('search', $s, $offset, $perPage);
      ...
      <?php
        ...
        printf("Không tìm thấy sản phẩm liên quan đến: <strong>'%s'</strong>", $s);
      }
      ?>
    </div>
    <div class="container">
