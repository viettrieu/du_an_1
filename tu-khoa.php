...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $query = "SELECT title FROM ps_tag WHERE id = $id";
...
<div class="row page-wrapper">
  <div class="large-9 col-nop">
    <div class="row">
      ...
      $base_url = './index.php?action=tu-khoa&id=' . $id;
      $totalProduct =  totalProduct('tag', $id);
      $productList = productList('tag', $id, $offset, $perPage);
