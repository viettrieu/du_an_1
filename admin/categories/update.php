...
<body>
  ...
  if (isset($_POST['submit'])) {
    $sql = "update categories set category_name='" . $_POST['category_name'] . "' where category_id=" . $_POST['category_id'];
        ...
        <div class="">
          <form action="#" method="POST">
            <div class="form-group">
              <input type="text" name="category_id" class="form-control" value="<?php echo $category['category_id']; ?>"
                hidden>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <button type="submit" name="submit" class="btn btn-primary">Lưu danh mục</button>
            </div>
          </form>
        </div>
      </main>
