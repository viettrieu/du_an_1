  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <a href="./create.php" class="btn btn-primary my-2">Thêm sản phẩm</a>
          ...
          <table class="table table-hover table-bordered text-center">
            ...
            <tbody>
              ...
              $sql = "SELECT * FROM ((products
                    ...
                    inner JOIN  brands ON products.brand_id = brands.brand_id) order by products.product_id DESC;
                    ";
                ...
                echo '
                        <tr>
                            ...
                            <td>
                              ...
                              <a class="btn btn-primary" href="./update.php?id=' . $product["product_id"] . '">Sửa</a>
                              <a class="btn btn-danger"  href="./delete.php?id=' . $product["product_id"] . '">Xoá</a>
                            </td>
                        </tr>
                        ';
              }
