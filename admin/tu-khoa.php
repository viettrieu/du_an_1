...
if (isset($_POST['create_tag'])) {
  ...
  $query = "INSERT INTO ps_tag(title, content) VALUES
  ('$title', '$content')";
  if ($conn->query($query)) {
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="alert alert-success alert-dismissible fade show" role="alert">
                Bạn đã thêm thành công từ khóa <strong><?php echo $result[1]; ?></strong>
          ...
          <div class="card-body">
            <div class="table-responsive" id="tag_list">
              <table class="table table-center table-hover datatable">
                ...
                <tbody>
                  <?php
                  $query =  "SELECT ps_tag.id, ps_tag.title, DATE_FORMAT(ps_tag.published, '%e/%c/%Y') AS'published', COUNT(product_tag.tagId) AS 'luot' FROM ps_tag LEFT JOIN product_tag ON product_tag.tagId = ps_tag.id GROUP BY ps_tag.id";
                  $tag = $conn->query($query);
                  if ($tag->num_rows > 0) {
                  ...
                  <tr>
                    ...
                    <td class="text-right">
                      <a href="./index.php?action=sua-tu-khoa&id=<?php echo $row['id']; ?>"
