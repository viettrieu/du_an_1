  ...
  <div class="large-9 col-nop">
    <div class="row">
      ...
      <div class="col medium-12 small-12 large-6">
        <div class="post has-hover">
          <div class="box-image image-zoom">
            <a href="./bai-viet.html"><img src="./assets/img/blog-1.jpg"
      ...
      <div class="col medium-12 small-12 large-6">
        <div class="post has-hover">
          <div class="box-image image-zoom">
            <a href="./bai-viet.html"><img src="./assets/img/blog-4.jpg"
                alt="Chiếc bánh hamburger ngon nhất thế giới hiện tại" /></a>
          </div>
          <div class="box-text">
            <div class="post-meta flex-row">
      ...
      <div class="col medium-12 small-12 large-6">
        <div class="post has-hover">
          <div class="box-image image-zoom">
            <a href="./bai-viet.html"><img src="./assets/img/blog-3.jpg"
