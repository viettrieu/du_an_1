<section id="news-letter">
  <div class="row row-collapse" style="align-items: center">
    <div class="col medium-12 small-12 large-6 hide-for-medium">
      <div class="col-inner">
        <img src="./assets/img/banner_newsletter.png" alt="Newsletter" />
      </div>
    </div>
...
<div class="cart-side">
  ...
  <div class="widget_shopping_cart">
    ...
    <div class="mini-cart-total">
      ...
      <a href="./index.php?action=thanh-toan" class="button secondary">
        THANH TOÁN
      </a>
      <a href="./index.php?action=gio-hang" class="button primary">
        GIỎ HÀNG
      </a>
    </div>
  </div>
...
<?php if ($page == 'cau-hoi-thuong-gap') : ?>
<script>
(function($) {
