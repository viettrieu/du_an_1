  ...
  <div class="row page-wrapper row-divided yproduct">
    <div class="col medium-12 small-12 large-7">
      ...
      <div class="form-control">
        ...
        <input id="fullName" name="fullName" type="text" value="<?php echo $fullName; ?>" size="30" required />
      </div>
      <div class="form-control">
        <label for="email">
          Email
      ...
      <div class="form-control phone">
        ...
        <div class="input-group">
          <input id="mobile" name="mobile" type="tel" value="<?php echo $mobile; ?>" size="30" required
      ...
      <div class="form-control">
        ...
        <input id="address" name="address" type="text" value="<?php echo $address; ?>" required autocomplete="off" />
      ...
      <div class="form-control">
        ...
        <textarea id="order-comments" name="order-comments" cols="45" rows="8" maxlength="1000"
    ...
    <div class="col medium-12 small-12 large-5">
      <div class="cart-totals">
        ...
        <div class="proceed-to-checkout">
          <button type="submit" class="button secondary checkout-button">
            THANH TOÁN
          </button>
        </div>
      </div>
